...
<head>
  <?php print $head; ?>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=0.50, target-densityDpi=320" />
...
body {background: url(<?php print _framework_path(); ?>/images/mobile_body_bckg.jpg); background-repeat: no-repeat; 
background-position: top left; background-color: #005daa; }
 #main {padding: 0px; background-color: transparent !important; background: url("<?php print _framework_path(); ?>/images/main_home_bck_fix.jpg"); background-position: bottom left; background-repeat: no-repeat;}
#main {margin-top: 21px; }
#contactUK { margin-top: -30px;}
#getmoreinformationaboutUK {display: block; text-align: center; padding: 10px;}
 ...
 ?>
	...
	background: url(<?php print _framework_path(); ?>/images/UniversityofKentucky.png); background-repeat: no-repeat; background-position: top left; background-color: #005daa; }
	 #main {margin-top: 25px; }
	 #page-title {margin-top: 10px;}
	 #contactUK { margin-top: 0px; padding-top: 10px;}

/*
 *  Sudo Slider ver 1.0.7 - jQuery plugin 
 ...
 */
 /* 
 TODO:
 Add keywords: captions, image, content. 
 ...
 No longer TODO
 Make the code for fading in/out controls less ugly. // Ended up being even more ugly.
 */
 /*
 ...
 1.0.6
 Bug fix: Fixed customLinks and first/last buttons fading out when continuous:true. (Thanks to Tim Doege for "finding" that one). 
 The 'destroy' action now also removes all click bindings on the customLinks. (Tim Doege also found this one). 

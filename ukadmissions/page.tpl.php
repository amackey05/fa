        ...
        <header id="header">
            <h1 id="logo"><a href="http://www.uky.edu" rel="home" title="University of Kentucky - See Blue"><img src="<?php print _ukadmissions_path(); ?>/images/logo.png" alt="University of Kentucky - See Blue" title="University of Kentucky - See Blue"></a></h1>
              <aside class="topRight">
                	<a href="http://www.uky.edu/Admission/application" title="Apply"><img src="<?php print _ukadmissions_path(); ?>/images/apply.png" alt="Apply" title="Apply"></a>
                    <a href="http://www.uky.edu/Admission/seebluevip" title="See Blue - VIP"><img src="<?php print _ukadmissions_path(); ?>/images/see-blue-vip.png" alt="See Blue - VIP" title="See Blue - VIP"></a>
                </aside>
        </header>
        <!-- header Ends -->
            ...
            <!--Banner Ends-->
				...
				?></h2>
                            ...
                            <div style="clear:both;">
								...
								<?php if((strlen($content) > 2048) ) print $content; 
										else if ( strlen(menu_tree_output($tree)) < 1800 )
												print $content;
										else print $content . "<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>";
										// REALLY short content gets EXTRA breaks.
										if(strlen($content) < 500) print "<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>";
								
								?>
								<?php print "<!-- Menu Length: " . strlen(menu_tree_output($tree)) . " / " . strlen($content) . " -->"; ?>
                            </div>
                        </article>
                        <aside class="sidebar">
...
<iframe style="overflow:hidden;" src="http://www.uky.edu/seeblue/index_formonly_admissions_update.php" width="900" title="get more information about attending UK" height="100"><p>Get More Info? Go to <a href="http://www.seeblue.com">seeblue.com</a></p></iframe> 
<!--
<iframe style="overflow:hidden;" src="http://www.seeblue.com/index_formonly_admissions.php" width="890" height="90"><p>Get More Info? Go to <a href=v"http://www.seeblue.com">seeblue.com</a></p></iframe> 
	...
	<script type="text/javascript">
		...
		*/
		...
		if((nav_height + 115) > content_height) {
			$('section.right').css("min-height",nav_height+200); 
